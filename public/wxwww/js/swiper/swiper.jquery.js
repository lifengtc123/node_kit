    ...
    var Swiper = function (container, params) {
        ...
        s.updateSlidesSize = function () {
            ...
            if (typeof spaceBetween === 'string' && spaceBetween.indexOf('%') >= 0) {
                spaceBetween = parseFloat(spaceBetween.replace('%', '')) / 100 * (s.size-1);
            }
            ...
            if (s.params.spaceBetween !== 0) {
                if (isH()) {
                    if (s.rtl) s.slides.css({marginLeft: spaceBetween + '%'});
                    else s.slides.css({marginRight: spaceBetween + '%'});
                }
                else s.slides.css({marginBottom: spaceBetween + '%'});
            }
