    ...
    MyDropLoad.prototype.init = function(options){
        ...
        me.opts = $.extend({}, {
            domUp : {                                                            // 上方DOM
                ...
                domRefresh : '<div class="dropload-refresh" style="font-size:12px;">↓下拉刷新</div>',
                domUpdate  : '<div class="dropload-update" style="font-size:12px;">↑释放更新</div>',
                domLoad    : '<div class="dropload-load" style="font-size:12px;">○加载中...</div>'
            },
            domDown : {                                                          // 下方DOM
