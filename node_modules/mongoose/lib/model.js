...
Model.execPageQuery = function find (currentPage,pageSize, conditions, fields, options,populate, callback) {
    if ('function' == typeof conditions) {
        callback = conditions;
        //conditions = {};
        //fields = null;
        ...
        callback = options;
        //   options = null;
    } else if ('function' == typeof populate){
        callback = populate;
    }
    ...
    async.parallel([
        ...
        function(cb) {
            if ('function' == typeof conditions) {
                ...
                var q=m.find(conditions,fields,options).limit(pageSize).skip(StartLine);
                for(var x in populate){
